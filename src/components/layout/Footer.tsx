export default function Footer() {
  return (
    <footer className="relative bottom-0 flex justify-center items-center text-white p-4 mt-2 sm:mt-4 lg:mt-6 lg:gap-6 bg-gradient-to-r from-indigo-950/80 to-blue-700/70">
